...
<ul>
 <li>Инструменты: SQL (Oracle), Работа с базами данных.</li>
 <li>Аналитика: Статистический анализ, визуализация данных, подготовка отчетов.</li>
 <li>Soft Skills: Быстрая адаптивность, системное мышление.</li>
</ul>
...
<p><img src="images/info.png" width="20">&nbsp;Özüm haqqında qısaca&nbsp;<img src="images/s2.png" width="60"></p>
...
<p><strong>Əsas kompetensiyalar:</strong></p>
<ul>
 <li>Alətlər: SQL (Oracle), Verilənlər bazası ilə iş.</li>
 <li>Analitika: Statistik analiz, verilənlərin vizuallaşdırılması, hesabatların hazırlanması.</li>
 <li>Soft Skills (bacarıqlar): Sürətli adaptasiya, sistemli təfəkkür.</li>
</ul>
<p><strong>Yükləmək üçün CV:</strong></p>
<ul>
  <li><a href="CV_KH_v1_az.pdf">CV_KH_v1_az.pdf</a> (Azərbaycan dilində CV)</li>
  <li><a href="CV_KH_v1_ru.pdf">CV_KH_v1_ru.pdf</a> (Rus dilində CV)</li>
</ul>
